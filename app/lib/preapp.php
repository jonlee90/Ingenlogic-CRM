...
// include_once(app_path().'/lib/class.uuid.php');
/*
...
$sess_key = Session::get('login_key'); // UUID
$sess_login_id = de_obfs(Session::get('sess_login_id')); // user ID is saved obfuscated. de-obfs the ID when assigning to a variable

// reset temporary Session values
if (Session::get('toastMsg') !='')
	$sess_toast_msg = Session::pull('toastMsg');
if (Session::get('tmpPOST') !='')
	$sess_temp_post = Session::pull('tmpPOST');
